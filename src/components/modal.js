...
import CircleDefaultImg from '../admin/static/images/account_circle.svg';
import SquareDefaultImg from '../admin/static/images/account_box.svg';
              ...
              <form className="modal-box">
                <div className="img-upload">
                  <div className="file-u">
                    <img src={photo ?? CircleDefaultImg} />
                  </div>
                  <div className="file-v">
                    <img src={idCard ?? SquareDefaultImg} />
                  </div>
                </div>
